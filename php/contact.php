...
define('EMAIL_RECIPIENT', 'contact@krishnatemplemilwaukee.org');
// Enter the email subject
define('EMAIL_SUBJECT', 'Hare Krishna ... Email from Contact form');
...
function send_email($data) {
    ...
    $msg = "Hari Bol !!!!, You have been contacted by {$data['name']}, their additional message is as follows." . PHP_EOL . PHP_EOL;
